...
export const MainArticle = () => {
  return (
    <section className="mb-12 " >
      <picture>
        <source media="(max-width: 640px)" srcSet="image-web-3-mobile.jpg" />
        <source media="(min-width: 641px)" srcSet="image-web-3-desktop.jpg" />
        <img src="image-web-3-mobile.jpg" alt="Articulo Principal imagen" />
      </picture>
